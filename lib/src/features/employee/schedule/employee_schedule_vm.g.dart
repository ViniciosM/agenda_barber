...
abstract class _$EmployeeScheduleVM
  ...
  FutureOr<List<ScheduleModel>> build(int userId, DateTime date);
}
...
class EmployeeScheduleVMFamily extends Family<AsyncValue<List<ScheduleModel>>> {
  ...
  /// See also [EmployeeScheduleVM].
  EmployeeScheduleVMProvider call(int userId, DateTime date) {
    return EmployeeScheduleVMProvider(userId, date);
  }
  ...
  EmployeeScheduleVMProvider getProviderOverride(
    ...
    return call(provider.userId, provider.date);
  }
...
/// See also [EmployeeScheduleVM].
class EmployeeScheduleVMProvider
    extends
        ...
        > {
  /// See also [EmployeeScheduleVM].
  EmployeeScheduleVMProvider(int userId, DateTime date)
    : this._internal(
        () =>
            EmployeeScheduleVM()
              ..userId = userId
  ...
  FutureOr<List<ScheduleModel>> runNotifierBuild(
    ...
    return notifier.build(userId, date);
  }
